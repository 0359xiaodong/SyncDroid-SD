...
public class ScpFileTransferClient extends AbstractFileTransferClient {
    ...
    public ScpFileTransferClient(String hostname, String username, String password, Activity activity) {
    ...
    public boolean connect() {
        try {
            ...
            try {
                ...
                Log.i(TAG, "adding identify: host '" + host + "' with fingerprint '" + fingerPrint + "' " +
                        "and key '" + key + "'");
